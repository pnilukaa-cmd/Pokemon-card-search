...
> **49.9% mean · 48.0% median · 20 of 44 winning matchups · rank 30 of 45**
>
> Best `selective_bloom_cradily` 100% · worst `water_aggro` 24%.
>
...
|---|---|---|
| greedy | 48.9% | 30 of 45 |
| **`setup`** | **55.8%** | **14 of 45** |

**+6.89 points, 95% CI [+5.59, +8.19].** The shape is the same for all three
