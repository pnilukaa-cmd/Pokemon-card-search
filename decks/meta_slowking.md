...
> **44.6% mean · 43.5% median · 11 of 44 winning matchups · rank 35 of 45**
>
> Best `selective_bloom_cradily` 100% · worst `team_rockets_persian_ex_attack_theft` 17%.
>
...
`Slowking` SCR 58's `Seek Inspiration` discards the top card of your own deck and uses that Pokemon's attack. `Kyurem` is in the list to be **copied**, not cast -- which is why its `Trifrost` reads as uncastable in the energy check and why that flag is harmless here.
